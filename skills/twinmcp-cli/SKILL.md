---
name: twinmcp-cli
description: Use the ctx7 CLI to fetch library documentation, manage AI coding skills, and configure TwinMCP MCP. Activate when the user mentions "ctx7" or "twinmcp", needs current docs for any library, wants to install/search/generate skills, or needs to set up TwinMCP for their AI coding agent.
---

# ctx7 CLI

The TwinMCP CLI does three things: fetches up-to-date library documentation, manages AI coding skills, and sets up TwinMCP MCP for your editor.
...
- **[Setup](references/setup.md)** — Configure TwinMCP MCP for Claude Code / Cursor / OpenCode.
...
# Setup
ctx7 setup                            # Configure TwinMCP MCP (interactive)
