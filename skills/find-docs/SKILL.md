...
Retrieve current documentation and code examples for any library using the TwinMCP CLI.
...
1. Inform the user their TwinMCP quota is exhausted
...
Do not silently fall back to training data — always tell the user why TwinMCP was not used.
