...
export function LimitsDisplay({ limits, showUpgradeButton, onUpgrade }: LimitsDisplayProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-slate-800/50 backdrop-blur border border-purple-500/20 rounded-xl">
      {/* Agents Limit */}
      <div className="p-4 border rounded-lg border-purple-500/20">
        ...
        <div className="w-full bg-gray-700 rounded-full h-2 mt-2">
          <div
            ...
            style={{ width: `${Math.min(limits.agents.percentage, 100)}%` }}
          />
        </div>
      </div>
      ...
      <div className="p-4 border rounded-lg border-purple-500/20">
        ...
        <div className="w-full bg-gray-700 rounded-full h-2 mt-2">
          <div
            ...
            style={{ width: `${Math.min(limits.conversations.percentage, 100)}%` }}
          />
        </div>
      </div>
