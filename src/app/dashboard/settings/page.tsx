...
import { Settings, User, Shield, Bell, Palette, Database, Key, Trash2, Save, Eye, EyeOff, Copy, Check } from "lucide-react";
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br from-[#8b5cf6]/40 to-[#ef4d95]/25 border border-[#8b5cf6]/30"
                ...
                <Settings className="w-5 h-5 text-[#ef4d95]" />
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white/6 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 bg-white/6 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition resize-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between p-4 bg-white/3 rounded-lg border border-white/6">
                        <div>
                  ...
                  <div className="space-y-6">
                    <div className="p-4 bg-blue-900/20 border border-blue-500/20 rounded-lg">
                      ...
                      <div className="flex items-center gap-3 p-3 bg-white/6 rounded-lg border border-white/10">
                        ...
                        <button
                          onClick={() => copyToClipboard("sk-abc123def456ghi789jkl012mno345pqr")}
                          className="p-2 text-gray-400 hover:text-white transition"
                        >
