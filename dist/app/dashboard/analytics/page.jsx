          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br from-[#8b5cf6]/40 to-[#ef4d95]/25 border border-[#8b5cf6]/30" style={{ boxShadow: "0 6px 30px rgba(139,92,246,0.18)" }}>
                <lucide_react_1.Activity className="w-5 h-5 text-[#ef4d95]"/>
              </div>
            ...
            <div className="flex items-center space-x-4">
              <select value={selectedPeriod} onChange={(e) => setSelectedPeriod(e.target.value)} className="bg-white/6 border border-white/10 rounded-lg px-3 py-2 text-sm backdrop-blur-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {analyticsData.overview.map((item, index) => {
            ...
            return (<div key={index} className="p-6 rounded-2xl bg-[rgba(255,255,255,0.03)] border border-white/6 backdrop-blur-lg relative overflow-hidden hover:scale-[1.02] transition-transform" style={{ boxShadow: getNeonGlow(item.color) }}>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-white/6 border border-white/6" style={{ boxShadow: getNeonGlow(item.color) }}>
                  ...
                  <div className={`text-sm ${item.trend === 'up' ? 'text-green-400' : 'text-red-400'} flex items-center gap-1`}>
                    {item.trend === 'up' ? <lucide_react_1.ArrowUpRight className="w-4 h-4"/> : <lucide_react_1.ArrowDownRight className="w-4 h-4"/>}
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          {/* Conversations Chart */}
          <div className="p-6 rounded-2xl bg-[rgba(255,255,255,0.02)] border border-white/6 backdrop-blur" style={{ boxShadow: getNeonGlow('blue') }}>
          ...
          {/* Performance Chart */}
          <div className="p-6 rounded-2xl bg-[rgba(255,255,255,0.02)] border border-white/6 backdrop-blur" style={{ boxShadow: getNeonGlow('green') }}>
            <div className="flex items-center justify-between mb-6">
            ...
            <div className="space-y-4">
              {analyticsData.topAgents.map((agent, index) => (<div key={index} className="flex items-center justify-between p-3 rounded-lg bg-white/3 border border-white/6">
                  <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {/* Response Time */}
          <div className="p-6 rounded-2xl bg-[rgba(255,255,255,0.02)] border border-white/6 backdrop-blur" style={{ boxShadow: getNeonGlow('purple') }}>
            ...
            <div className="h-32 rounded-lg bg-gradient-to-br from-black/20 to-black/10 border border-white/5 flex items-center justify-center">
              <lucide_react_1.Clock className="w-8 h-8 text-purple-400"/>
            </div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-[rgba(255,255,255,0.02)] border border-white/6 backdrop-blur" style={{ boxShadow: getNeonGlow('green') }}>
            ...
            <div className="h-32 rounded-lg bg-gradient-to-br from-green-900/20 to-green-800/10 border border-green-500/20 flex items-center justify-center">
              <lucide_react_1.Target className="w-8 h-8 text-green-400"/>
            </div>
          </div>

          {/* Cost Analysis */}
          <div className="p-6 rounded-2xl bg-[rgba(255,255,255,0.02)] border border-white/6 backdrop-blur" style={{ boxShadow: getNeonGlow('pink') }}>
            ...
            <div className="h-32 rounded-lg bg-gradient-to-br from-pink-900/20 to-pink-800/10 border border-pink-500/20 flex items-center justify-center">
              <lucide_react_1.DollarSign className="w-8 h-8 text-pink-400"/>
            </div>
          </div>
        </div>
      </div>
