...
- **MCP Server** — Connects Cursor to TwinMCP's documentation service
- **Rules** — An always-on `use-twinmcp` rule that nudges the agent to fetch docs when unsure about library APIs
- **Skills** — A `twinmcp-docs-lookup` skill with detailed instructions on resolving libraries and fetching documentation
