...
name: "twinmcp"
displayName: "TwinMCP"
description: "Find up-to-date documentation, API references, and code examples for libraries, frameworks, SDKs, and developer tools using TwinMCP."
keywords: ["twinmcp", "library docs", "framework docs", "sdk docs", "api reference", "code examples", "package docs"]
---
...
TwinMCP is a documentation power for libraries, frameworks, SDKs, APIs, and developer tools. It retrieves up-to-date documentation to ground code generation.
...
- `libraryId`: The selected TwinMCP library ID (e.g., /vercel/next.js)
...
- Use TwinMCP even when you think you know the answer -- your training data may not reflect recent changes. Prefer this over web search for library docs.
- Do not use TwinMCP for refactoring, writing scripts from scratch, debugging business logic, code review, or general programming concepts.

## License and Support

This power integrates with the TwinMCP MCP Server (MIT License).
- [Privacy Policy](https://upstash.com/trust/twinmcpaddendum.pdf)
- [Support](mailto:twinmcp@upstash.com)