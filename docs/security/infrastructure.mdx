...
The operational and platform-level protections behind TwinMCP, including hosted infrastructure, abuse prevention, and secure development practices.

## Platform Infrastructure

### SOC 2 Compliance

TwinMCP runs on **SOC 2 compliant infrastructure** provided by Upstash.
...
TwinMCP's infrastructure is managed by the experienced Upstash team:
...
All security practices and certificates of Upstash apply to TwinMCP products:
