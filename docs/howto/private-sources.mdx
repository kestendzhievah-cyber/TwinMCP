...
Add private sources to TwinMCP to make your internal documentation available to AI coding assistants. You can add sources from GitHub, GitLab, Bitbucket, other Git providers, Confluence, and OpenAPI specifications.
...
4. **Authorize** TwinMCP to access your source (if required)
5. **Submit** for parsing

<Note>You must have a Pro or Enterprise plan to add private sources. Public sources can be added from the [Add Library](https://twinmcp.com/add-library) page.</Note>
...
2. TwinMCP re-parses the source
...
Add a `twinmcp.json` file to your repository root for better control over parsing:
