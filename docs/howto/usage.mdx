---
title: Monitor Usage
description: Monitor your TwinMCP API usage and track costs
---

Track your TwinMCP usage with real-time metrics from the **Overview** tab on your teamspace dashboard.
...
The total number of API calls made to TwinMCP, shown against your plan's included quota. Requests within your quota are free; excess requests are billed based on your plan.
...
See [Plans & Pricing](https://twinmcp.com/plans) for current rates and included quotas.
