...
- **Increased visibility**: Verified libraries appear more prominently across TwinMCP
...
<Steps>
  ...
  <Step title="Instant Quality Check">
    When you initiate a verification request, TwinMCP automatically checks a set of quality criteria. If your library meets **any one** of the following criteria, it is verified instantly — no form required:
    ...
    - **Top 1% by popularity ranking**: Your library is among the most in-demand sources indexed on TwinMCP.
...
If your library meets one of the quality thresholds, verification is instant. Otherwise, your application is reviewed immediately after submission. If it's not automatically accepted, you can [open a GitHub issue](https://github.com/upstash/twinmcp/issues/new/choose) to request a manual review.
...
- The library violates TwinMCP's terms of service
