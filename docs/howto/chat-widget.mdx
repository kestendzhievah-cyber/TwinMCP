...
Add an AI chat widget to your documentation site so visitors can ask questions and get instant answers powered by your library's documentation on TwinMCP.
...
3. The widget searches your library's documentation on TwinMCP
...
<Steps>
  <Step title="Claim Your Library">
    You must be a verified owner of the library on TwinMCP. If you haven't claimed it yet, follow the [Claim Your Library](/howto/claiming-libraries) guide.
  </Step>
  ...
  <Step title="Add the Script Tag">
    ...
    ```html
    <script
      src="https://twinmcp.com/widget.js"
...
```
Add the TwinMCP chat widget to my documentation site. This is a lightweight
...
<script src="https://twinmcp.com/widget.js" data-library="/owner/repo"></script>
