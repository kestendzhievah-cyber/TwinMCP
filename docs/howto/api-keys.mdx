---
title: API Keys
description: Create and manage API keys for TwinMCP authentication
---

API keys authenticate your requests to TwinMCP's documentation services.
...
```bash
curl "https://twinmcp.com/api/v2/context?libraryId=/vercel/next.js&query=routing" \
