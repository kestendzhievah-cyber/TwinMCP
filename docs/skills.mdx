---
title: Skills
description: Install, search, and manage AI coding assistant skills from the TwinMCP registry
---
...
TwinMCP maintains a registry of skills at [twinmcp.com/skills](https://twinmcp.com/skills) that can be installed directly into your AI coding assistant with a single command.
...
## The TwinMCP Skills Registry

The [TwinMCP Skills Registry](https://twinmcp.com/skills) is a searchable marketplace of skills indexed from GitHub repositories. Each skill is identified by its repository path (e.g., `/anthropics/skills`) and skill name.
...
TwinMCP vets every skill in the registry before it reaches you — both through automated scanning and community-driven quality signals.
...
TwinMCP automatically scans skills for potential security issues before they appear in the registry:
