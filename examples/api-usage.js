...
exports.asyncExecution = asyncExecution;
exports.batchExecution = batchExecution;
exports.getMetrics = getMetrics;
exports.healthCheck = healthCheck;
exports.robustExecution = robustExecution;
exports.jwtAuthentication = jwtAuthentication;
exports.webhookExample = webhookExample;
...
async function listTools() {
    ...
    console.log('Outils disponibles:', data.tools.map(t => t.name));
}
...
async function batchExecution() {
    ...
    const promises = tools.map(tool => fetch(`${API_BASE}/execute`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': API_KEY
