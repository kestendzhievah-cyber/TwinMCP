...
# Optional: serve the API on a dedicated origin (e.g. https://api.twinmcp.fr),
# isolated from the front-end. Leave unset to keep the API same-origin under
# /api/*. See docs/API-SUBDOMAIN.md.
