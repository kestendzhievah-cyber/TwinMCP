...
export const rateLimited = (apiKey: boolean) =>
  jsonError(
    429,
    apiKey
      ? "Rate limited or quota exceeded. Upgrade your plan at https://twinmcp.fr/plans for higher limits."
      : "Rate limited or quota exceeded. Create a free API key at https://twinmcp.fr/dashboard for higher limits."
  );
