/**
 * System prompts for TwinMCP AI SDK agents
 */

/**
 * Basic documentation assistant prompt
 */
export const SYSTEM_PROMPT = `You are a documentation search assistant powered by TwinMCP.
 ...
 */
export const AGENT_PROMPT = `You are a documentation search assistant powered by TwinMCP.
 ...
 */
export const RESOLVE_LIBRARY_ID_DESCRIPTION = `Resolves a package/product name to a TwinMCP-compatible library ID and returns matching libraries.

You MUST call this function before 'queryDocs' to obtain a valid TwinMCP-compatible library ID UNLESS the user explicitly provides a library ID in the format '/org/project' or '/org/project/version' in their query.
 ...
 */
export const QUERY_DOCS_DESCRIPTION = `Retrieves and queries up-to-date documentation and code examples from TwinMCP for any programming library or framework.

You must call 'resolveLibraryId' first to obtain the exact TwinMCP-compatible library ID required to use this tool, UNLESS the user explicitly provides a library ID in the format '/org/project' or '/org/project/version' in their query.
