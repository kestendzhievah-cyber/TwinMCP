...
exports.LibraryResolutionService = void 0;
const query_parser_service_1 = require("./query-parser.service");
class LibraryResolutionService {
    constructor(db, redis) {
        this.db = db;
        this.redis = redis;
        this.queryParser = new query_parser_service_1.QueryParserService();
    }
    ...
    async searchLibraries(parsed, input) {
        const conditions = [];
        const params = [];
        let paramIndex = 1;
    ...
    async scoreResults(results, parsed) {
        const scoredResults = [];
    ...
    async calculateRelevanceScore(library, parsed) {
        let score = 0;
        // Exact name match
    ...
    getMatchDetails(library, parsed) {
