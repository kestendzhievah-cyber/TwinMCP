...
export default function AgentBuilderPage() {
  ...
  const [systemPrompt, setSystemPrompt] = useState('Tu es un assistant IA utile et professionnel.');
  ...
  const [userLimits, setUserLimits] = useState<UserLimitsResponse | null>(null);
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1 mr-4">
                <input
                  ...
                  className="text-2xl font-bold text-white bg-transparent border-none outline-none mb-2 w-full"
                ...
                <input
                  ...
                  placeholder="Description de l'agent (optionnel)"
                />
              </div>
              <div className="flex space-x-3">
                <button
                  onClick={handleTestAgent}
                  className="px-4 py-2 bg-blue-500/20 text-blue-400 border border-blue-500/30 rounded-lg hover:bg-blue-500/30 transition flex items-center"
                >
                ...
                <button
                  ...
                  disabled={isSaving || !userLimits?.canCreateAgent}
                  className="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition flex items-center disabled:opacity-50"
                >
                  {isSaving ? (
                    <>
          ...
          <div className="space-y-6">
                ...
                {availableModels.map((model) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <span key={i} className={i < model.quality ? 'text-yellow-400' : 'text-gray-600'}>★</span>
                        ))}
                      </div>
                    </div>
                  </div>
            ...
            <div className="p-6 bg-slate-800/50 backdrop-blur border border-purple-500/20 rounded-xl">
              ...
              <div className="space-y-2">
                {connectedTools.length === 0 ? (
                  ...
                  connectedTools.map((toolId: string) => {
            ...
            <div className="p-6 bg-slate-800/50 backdrop-blur border border-purple-500/20 rounded-xl">
              ...
              <textarea
                ...
                className="w-full h-32 bg-slate-700/50 text-white rounded-lg p-3 border border-slate-600 focus:border-purple-500 outline-none resize-none text-sm"
              ...
              <div className="p-6 border-t border-purple-500/20">
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    disabled={isTyping}
                    className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition shadow-lg shadow-purple-500/50 disabled:opacity-50"
                  >
            ...
            <div className="bg-slate-800 rounded-2xl border border-purple-500/20 max-w-4xl w-full max-h-[80vh] overflow-y-auto">
              ...
              <div className="p-6 grid md:grid-cols-2 gap-4">
                {availableMCPTools.map((tool) => (
                  <div
                    key={tool.id}
                    onClick={() => tool.configured && toggleTool(tool.id)}
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      {connectedTools.includes(tool.id) ? (
                        ...
                        <div className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs font-semibold rounded border border-blue-500/30">
                          Disponible
                        </div>
                      ) : (
                        <div className="px-2 py-1 bg-gray-500/20 text-gray-400 text-xs font-semibold rounded border border-gray-500/30">
                          Non configuré
                        </div>
                      )}
                    </div>
