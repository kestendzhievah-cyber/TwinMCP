  ...
  const demoTasks = [
    {
      ...
      description:
        "L'agent va créer un paiement Stripe, générer une facture et l'envoyer par email via SendGrid",
    },
    {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl px-4 py-3 flex items-center gap-3">
        ...
        <p className="text-yellow-300 text-sm">
          Cette page est une <strong>démonstration interactive</strong>. Les résultats affichés sont
          simulés localement et ne déclenchent aucun appel API réel.
        </p>
      </div>
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto">
            ...
            {actions.map(action => {
              ...
              return (
                <div
                  key={action.id}
                  className="p-4 bg-[#0f1020] rounded-lg border border-purple-500/10"
                >
