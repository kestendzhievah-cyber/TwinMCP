      ...
      <div className="relative z-10">
        <nav className="sticky top-0 z-50 border-b border-purple-500/20 bg-[#1a1b2e]/90 backdrop-blur-xl">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-3">
                {saveSuccess && (<span className="text-sm text-green-400 flex items-center gap-2">
                    <lucide_react_1.Check className="w-4 h-4"/>
                    Sauvegardé !
                  </span>)}
                <button onClick={handleSave} className="px-5 py-2.5 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-sm font-semibold rounded-lg hover:from-pink-600 hover:to-purple-700 transition-all duration-200 shadow-lg shadow-pink-500/30 hover:shadow-pink-500/50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            return (<button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${isActive
              ...
              <div className="bg-[#1a1b2e] border border-purple-500/20 rounded-2xl p-8 backdrop-blur-xl">
                    ...
                    <div className="space-y-6">
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input type="text" defaultValue="John Doe" className="w-full px-4 py-3 bg-[#0f1020] border border-purple-500/30 rounded-lg text-white placeholder-gray-500 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 outline-none transition"/>
                        </div>
                        <div className="space-y-2">
                          <label className="flex items-center gap-2 text-sm font-medium text-gray-300">
                          ...
                          <input type="email" defaultValue="john@twinmcp.com" className="w-full px-4 py-3 bg-[#0f1020] border border-purple-500/30 rounded-lg text-white placeholder-gray-500 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 outline-none transition"/>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <label className="flex items-center gap-2 text-sm font-medium text-gray-300">
                        ...
                        <input type="text" defaultValue="TwinMCP" className="w-full px-4 py-3 bg-[#0f1020] border border-purple-500/30 rounded-lg text-white placeholder-gray-500 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 outline-none transition"/>
                      </div>
                      <div className="space-y-2">
                        <label className="flex items-center gap-2 text-sm font-medium text-gray-300">
                        ...
                        <textarea rows={4} defaultValue="Développeur passionné par l'IA et les nouvelles technologies." className="w-full px-4 py-3 bg-[#0f1020] border border-purple-500/30 rounded-lg text-white placeholder-gray-500 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 outline-none transition resize-none"/>
                      </div>
                    </div>
                  </div>)}
                ...
                {activeTab === "security" && (<div className="space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between p-5 bg-[#0f1020] rounded-xl border border-purple-500/30 hover:border-purple-500/50 transition-all group">
                        <div className="flex items-start gap-4">
                          <div className="w-12 h-12 rounded-xl bg-purple-500/20 flex items-center justify-center">
                            <lucide_react_1.Monitor className="w-6 h-6 text-purple-400"/>
                          </div>
                          <div>
                      ...
                      <div className="flex items-center justify-between p-5 bg-[#0f1020] rounded-xl border border-purple-500/30 hover:border-purple-500/50 transition-all group">
                        <div className="flex items-start gap-4">
                          <div className="w-12 h-12 rounded-xl bg-purple-500/20 flex items-center justify-center">
                            <lucide_react_1.Lock className="w-6 h-6 text-purple-400"/>
                          </div>
                          <div>
                    ...
                    <div className="p-6 bg-red-900/20 border border-red-500/30 rounded-xl">
                      <div className="flex items-center gap-3 mb-4">
                        <lucide_react_1.AlertTriangle className="w-6 h-6 text-red-400"/>
                ...
                {activeTab === "notifications" && (<div className="space-y-8">
                    ...
                    <div className="space-y-3">
                      {[
                { title: "Nouveaux messages", description: "Recevoir des notifications pour les nouveaux messages", icon: lucide_react_1.Mail, checked: true },
                { title: "Rapports hebdomadaires", description: "Résumé de l'activité de vos serveurs MCP", icon: lucide_react_1.FileText, checked: true },
                { title: "Alertes de sécurité", description: "Notifications importantes pour la sécurité", icon: lucide_react_1.Shield, checked: true },
                { title: "Mises à jour produit", description: "Informations sur les nouvelles fonctionnalités", icon: lucide_react_1.Settings, checked: false }
            ].map((item, index) => {
                const Icon = item.icon;
                return (<div key={index} className="flex items-center justify-between p-5 bg-[#0f1020] rounded-xl border border-purple-500/30 hover:border-purple-500/50 transition-all group">
                ...
                { name: "TwinMCP", gradient: "from-pink-500 to-purple-600", active: true }
            ].map((theme) => (<button key={theme.name} className={`relative p-6 rounded-xl border-2 transition-all ${theme.active
                    ...
                    : "border-purple-500/30 hover:border-purple-500/50"}`}>
                              ...
                              {theme.active && (<div className="absolute top-3 right-3 w-6 h-6 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center">
                                  <lucide_react_1.Check className="w-4 h-4"/>
                                </div>)}
                            </button>))}
                        </div>
