...
export default function SettingsPage() {
  ...
  const handleNotifChange = (key: keyof NotificationPrefs) => {
    setNotifPrefs(prev => {
      ...
      try {
        localStorage.setItem('twinmcp_notif_prefs', JSON.stringify(updated));
      } catch {
        /* ignore */
      }
      return updated;
  ...
  const handleThemeChange = (theme: DashboardTheme) => {
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent('twinmcp-dashboard-theme-change', { detail: { theme } })
      );
    } catch {
      // ignore
    }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {activeTab === 'profile' && (
          <div className="flex items-center gap-3">
            {saveMessage && (
              <span
                className={`text-sm flex items-center gap-1 ${saveMessage.type === 'success' ? 'text-green-400' : 'text-red-400'}`}
              >
          ...
          {activeTab === 'profile' && (
            <div className="space-y-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500">
                        L'email est lié à votre compte Firebase et ne peut pas être modifié ici.
                      </p>
                    </div>
              ...
              <div className="bg-[#1a1b2e] border border-purple-500/20 rounded-2xl p-6">
                ...
                <p className="text-sm text-gray-400 mb-6">
                  Utilisée pour la facturation et les communications.
                </p>
                      ...
                      {userPlan === 'free'
                        ...
                        : profile?.subscription?.status === 'active'
                          ...
                          : `Statut de l'abonnement : ${
                              profile?.subscription?.status || 'inconnu'
                            }`}
                    </p>
            ...
            <div className="space-y-6">
              <div className="bg-[#1a1b2e] border border-purple-500/20 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  {securityMessage && (
                    <div
                      className={`p-4 rounded-xl flex items-center gap-3 ${securityMessage.type === 'success' ? 'bg-green-500/10 border border-green-500/30' : 'bg-red-500/10 border border-red-500/30'}`}
                    >
                      ...
                      <p
                        className={`text-sm ${securityMessage.type === 'success' ? 'text-green-400' : 'text-red-400'}`}
                      >
                    ...
                    <button
                      onClick={async () => {
                        ...
                        try {
                          ...
                          setSecurityMessage({
                            type: 'error',
                            text: err.message || "Erreur lors de l'envoi",
                          });
                        } finally {
              ...
              <div className="bg-[#1a1b2e] border border-red-500/30 rounded-2xl p-6">
                ...
                <p className="text-sm text-gray-400 mb-4">
                  La suppression de votre compte est irréversible. Toutes vos données, clés API et
                  configurations seront définitivement perdues.
                </p>
                {!showDeleteConfirm ? (
                  <button
                  ...
                  <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl space-y-3">
                    <p className="text-sm text-red-300">
                      Tapez <strong className="text-red-400">SUPPRIMER</strong> pour confirmer la
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            if (err.code === 'auth/requires-recent-login') {
                              setSecurityMessage({
                                type: 'error',
                                text: 'Veuillez vous reconnecter avant de supprimer votre compte (sécurité Firebase).',
                              });
                            } else {
                              setSecurityMessage({
                                type: 'error',
            ...
            <div className="space-y-6">
              <div className="bg-[#1a1b2e] border border-purple-500/20 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  {[
                    {
                      key: 'emailNewMessages' as const,
                      title: 'Nouveaux messages',
                      desc: 'Notifications pour les nouveaux messages et réponses',
                      icon: Mail,
                    },
                    {
                      key: 'emailWeeklyReport' as const,
                      title: 'Rapports hebdomadaires',
                      desc: "Résumé de l'activité de vos serveurs MCP",
                      icon: FileText,
                    },
                    {
                      key: 'emailSecurityAlerts' as const,
                      title: 'Alertes de sécurité',
                      desc: 'Connexions suspectes et changements de mot de passe',
                      icon: Shield,
                    },
                    {
                      key: 'emailUsageAlerts' as const,
                      title: "Alertes d'utilisation",
                      desc: 'Notification quand vous approchez de votre limite',
                      icon: AlertTriangle,
                    },
                    {
                    ...
                    return (
                      <div
                        key={item.key}
                        className="flex items-center justify-between gap-4 p-4 bg-[#0f1020] rounded-xl border border-purple-500/20 hover:border-purple-500/40 transition"
                      >
                ...
                <div className="grid grid-cols-3 gap-4">
                  {themeOptions.map(theme => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-full h-16 rounded-lg bg-gradient-to-br ${theme.gradient} mb-3`}
                        />
