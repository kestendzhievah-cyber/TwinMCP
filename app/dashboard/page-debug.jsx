...
function DebugPage() {
    const [test, setTest] = (0, react_1.useState)('test');
    return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <button onClick={() => setTest('updated')} className="px-4 py-2 bg-purple-600 text-white rounded-lg mt-4">
          Update State
        </button>
      </div>
    </div>);
}
//# sourceMappingURL=page-debug.jsx.map