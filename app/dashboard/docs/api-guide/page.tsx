...
const response = await fetch('${API_BASE_URL}/api/v1/mcp/auth', {
  method: 'POST',
  headers: {
      ...
      <div className="bg-gradient-to-r from-fuchsia-600/20 to-purple-600/20 border border-fuchsia-500/30 rounded-xl p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <div className="w-6 h-6 bg-fuchsia-600 rounded-full flex items-center justify-center text-white text-sm font-bold">
              1
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-300">
              Utilisez les endpoints MCP pour exécuter des outils
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#1a1a2e] border border-purple-700/30 rounded-xl p-6 space-y-4">
          ...
          <p className="text-gray-300">
            Pour utiliser l'API TwinMCP, vous devez vous authentifier avec une clé API ou un token
            JWT.
          </p>
...

{
  "apiKey": "your-api-key-here"
            ...
            <div>
              ...
              <div className="bg-[#0a0a0f] border border-purple-700/30 rounded-lg p-4 font-mono text-sm">
                <pre className="text-green-400">{`Authorization: Bearer your-jwt-token`}</pre>
              </div>
            </div>
          </div>
        </div>
