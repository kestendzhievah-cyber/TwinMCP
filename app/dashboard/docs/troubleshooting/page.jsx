...
function TroubleshootingPage() {
    const commonIssues = [
        ...
        },
        {
            ...
            code: "curl -X POST http://localhost:3000/api/v1/mcp/auth \\\n  -H 'Content-Type: application/json' \\\n  -d '{\"apiKey\":\"your-api-key\"}'"
        },
        {
    ...
    return (<div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-xl p-6">
        <h2 className="text-xl font-semibold text-blue-300 mb-4 flex items-center gap-2">
          <lucide_react_1.Wrench className="w-5 h-5"/>
          Diagnostics rapides
        </h2>
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            <lucide_react_1.CheckCircle className="w-5 h-5 text-green-400"/>
            <span className="text-gray-300">Testez la connectivité: <code className="text-fuchsia-400">curl http://localhost:3000/api/v1/mcp/health</code></span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        {commonIssues.map((issue, index) => (<div key={index} className="bg-[#1a1a2e] border border-purple-700/30 rounded-xl p-6 space-y-4">
            <div className="flex items-start gap-3">
              <lucide_react_1.AlertTriangle className="w-5 h-5 text-yellow-400 mt-1"/>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#1a1a2e] border border-purple-700/30 rounded-xl p-6">
          <h3 className="text-lg font-semibold text-gray-100 mb-4 flex items-center gap-2">
            <lucide_react_1.Terminal className="w-5 h-5 text-purple-400"/>
...
VERBOSE=true`}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#1a1a2e] border border-purple-700/30 rounded-xl p-6">
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <lucide_react_1.RefreshCw className="w-5 h-5 text-yellow-400 mt-1"/>
              <div>
      ...
      <div className="bg-gradient-to-r from-fuchsia-600/20 to-purple-600/20 border border-fuchsia-500/30 rounded-xl p-6">
        ...
        <div className="space-y-3">
          <link_1.default href="/dashboard/docs/api-guide" className="flex items-center gap-3 text-gray-300 hover:text-fuchsia-300 transition-colors">
