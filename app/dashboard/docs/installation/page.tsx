      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-fuchsia-600 rounded-full flex items-center justify-center text-white font-bold">
              1
            </div>
          ...
          <div className="bg-[#0a0a0f] border border-purple-700/30 rounded-lg p-4 font-mono text-sm">
            ...
            <code className="text-green-400">
              git clone https://github.com/kestendzhievah-cyber/TwinMe.IA
            </code>
            <br />
          ...
          <div className="bg-yellow-900/20 border border-yellow-600/30 rounded-lg p-4">
            <div className="flex items-start gap-2">
              ...
              <div className="text-yellow-300 text-sm">
                ...
                <p>
                  L'option --legacy-peer-deps est nécessaire pour résoudre les conflits de
                  dépendances avec Next.js 15.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-300">Le serveur démarrera sur {APP_URL}</p>
        </div>
      </div>
        ...
        <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
          <div className="flex items-start gap-2">
            ...
            <div className="text-blue-300 text-sm">
              ...
              <p>
                Vous pouvez générer un token JWT via l'interface d'administration dans le dashboard.
              </p>
            </div>
          </div>
        </div>
