...
exports.default = InstallationPage;
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#0a0a0f] border border-purple-700/30 rounded-lg p-4 font-mono text-sm">
            <div className="flex items-center gap-2 mb-2">
              <lucide_react_1.Terminal className="w-4 h-4 text-fuchsia-400"/>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-yellow-900/20 border border-yellow-600/30 rounded-lg p-4">
            <div className="flex items-start gap-2">
              <lucide_react_1.AlertCircle className="w-5 h-5 text-yellow-400 mt-0.5"/>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#1a1a2e] border border-purple-700/30 rounded-xl p-6 space-y-4">
          <h3 className="text-lg font-semibold text-gray-100 flex items-center gap-2">
            <lucide_react_1.Settings className="w-5 h-5 text-purple-400"/>
            Configuration JSON
          </h3>
          <p className="text-gray-300">
    ...
    "twinmcp": {
      ...
      "headers": {
        ...
        <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
          <div className="flex items-start gap-2">
            <lucide_react_1.AlertCircle className="w-5 h-5 text-blue-400 mt-0.5"/>
