    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="p-6 bg-[#1a1b2e] border border-green-500/30 rounded-xl mb-8">
        ...
        <p className="text-gray-300 mb-6">
          Copiez la configuration correspondant à votre client LLM. Remplacez{' '}
          <code className="text-purple-400">YOUR_API_KEY</code> par votre clé API (
          <a href="/dashboard/api-keys" className="text-purple-400 underline hover:text-purple-300">
            obtenir une clé
          </a>
          ).
        </p>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">
              Fichier:{' '}
              <code className="text-gray-300">~/.config/claude/claude_desktop_config.json</code>{' '}
              (macOS/Linux) ou{' '}
              <code className="text-gray-300">%APPDATA%\Claude\claude_desktop_config.json</code>{' '}
              (Windows)
            </p>
    ...
    "twinmcp": {
      ...
      "args": ["-y", "@twinmcp/mcp", "--api-key", "YOUR_API_KEY"]
          ...
          <div>
            ...
            <div className="relative">
              <CopyButton
                text="claude mcp add twinmcp -- npx -y @twinmcp/mcp --api-key YOUR_API_KEY"
                id="claude-code"
              />
              <pre className="bg-[#0a0a14] p-4 rounded-lg overflow-x-auto text-sm">
                <code className="text-green-400">
    ...
    "twinmcp": {
      ...
      "args": ["-y", "@twinmcp/mcp", "--api-key", "YOUR_API_KEY"]
          ...
          <div>
            ...
            <div className="relative">
              <CopyButton
                text={`curl -X POST https://YOUR_DOMAIN/api/mcp \\
  ...
  -d '{"jsonrpc":"2.0","id":1,"method":"tools/list"}'`}</code>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-[#0f1020] rounded-lg">
            ...
            <p className="text-sm text-gray-400 mb-1">
              <code className="text-green-400">POST /api/mcp</code>
            </p>
          ...
          <div className="p-4 bg-[#0f1020] rounded-lg">
            ...
            <p className="text-sm text-gray-400 mb-1">
              <code className="text-green-400">GET /api/mcp/sse</code>
            </p>
          ...
          <div className="p-4 bg-[#0f1020] rounded-lg">
            ...
            <p className="text-sm text-gray-400 mb-1">
              <code className="text-green-400">npx @twinmcp/mcp</code>
            </p>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-[#0f1020] rounded-lg">
            ...
            <p className="text-sm text-gray-300 mb-2">
              Résout un nom de bibliothèque et retourne son identifiant TwinMCP.
            </p>
            <p className="text-xs text-gray-500">
              Params: <code>query</code> (string), <code>libraryName</code> (string)
            </p>
          </div>
          <div className="p-4 bg-[#0f1020] rounded-lg">
            <h3 className="font-bold text-purple-400 mb-2">query-docs</h3>
            <p className="text-sm text-gray-300 mb-2">
              Recherche la documentation d&apos;une bibliothèque spécifique. Retourne des snippets
              de code et des guides.
            </p>
            <p className="text-xs text-gray-500">
              Params: <code>libraryId</code> (string), <code>query</code> (string),{' '}
              <code>version</code>?, <code>maxResults</code>?, <code>maxTokens</code>?
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 bg-[#1a1b2e] border border-purple-500/20 rounded-xl mb-8">
        ...
        <p className="text-gray-300 mb-4">
          ...
          (Model Context Protocol) pour automatiser des tâches complexes comme le traitement des
          paiements, l&apos;envoi d&apos;emails et la gestion des issues GitHub.
        </p>
        <div className="flex items-center text-green-400">
          <CheckCircle className="w-5 h-5 mr-2" />
          <span>
            Démonstration interactive disponible :{' '}
            <a href="/dashboard/agent-mcp-demo" className="underline hover:text-green-300">
              Voir la démo
            </a>
          </span>
        </div>
