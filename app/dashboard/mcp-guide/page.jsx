      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2 flex items-center">
            <lucide_react_1.BookOpen className="w-10 h-10 mr-3 text-purple-400"/>
        ...
        <div className="p-6 bg-slate-800/50 backdrop-blur border border-purple-500/20 rounded-xl mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-4 bg-slate-700/50 rounded-lg">
              <lucide_react_1.CreditCard className="w-8 h-8 text-green-400 mb-3"/>
            ...
            <div className="p-4 bg-slate-700/50 rounded-lg">
              <lucide_react_1.Mail className="w-8 h-8 text-blue-400 mb-3"/>
            ...
            <div className="p-4 bg-slate-700/50 rounded-lg">
              <lucide_react_1.Github className="w-8 h-8 text-purple-400 mb-3"/>
        ...
        <div className="p-6 bg-slate-800/50 backdrop-blur border border-purple-500/20 rounded-xl mb-8">
          <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
            <lucide_react_1.Code className="w-6 h-6 mr-2"/>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-bold text-green-400 mb-3 flex items-center">
                <lucide_react_1.CreditCard className="w-5 h-5 mr-2"/>
                Stripe MCP
              </h3>
            ...
            <div>
              <h3 className="text-lg font-bold text-purple-400 mb-3 flex items-center">
                <lucide_react_1.Github className="w-5 h-5 mr-2"/>
                GitHub MCP
              </h3>
              <ul className="space-y-2 text-sm text-gray-300">
    ...
    github: await initGitHubMCP()
        ...
        <div className="p-6 bg-slate-800/50 backdrop-blur border border-purple-500/20 rounded-xl">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <a href="https://docs.stripe.com/api" className="p-4 bg-slate-700/50 rounded-lg hover:bg-slate-700/70 transition flex items-center">
              <lucide_react_1.ExternalLink className="w-5 h-5 mr-3 text-green-400"/>
              <div>
            ...
            <a href="https://docs.sendgrid.com/api-reference" className="p-4 bg-slate-700/50 rounded-lg hover:bg-slate-700/70 transition flex items-center">
              <lucide_react_1.ExternalLink className="w-5 h-5 mr-3 text-blue-400"/>
              <div>
            ...
            <a href="https://docs.github.com/rest" className="p-4 bg-slate-700/50 rounded-lg hover:bg-slate-700/70 transition flex items-center">
              <lucide_react_1.ExternalLink className="w-5 h-5 mr-3 text-purple-400"/>
              <div>
            ...
            <a href="/dashboard/marketplace" className="p-4 bg-slate-700/50 rounded-lg hover:bg-slate-700/70 transition flex items-center">
              <lucide_react_1.ExternalLink className="w-5 h-5 mr-3 text-orange-400"/>
              <div>
        ...
        <div className="p-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-xl text-center">
          ...
          <div className="flex items-center justify-center space-x-4">
            <a href="/dashboard/agent-mcp-demo" className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition flex items-center">
              <lucide_react_1.Zap className="w-5 h-5 mr-2"/>
              Voir la démonstration
            </a>
            <a href="/dashboard/marketplace" className="px-6 py-3 bg-slate-700 text-white font-semibold rounded-lg hover:bg-slate-600 transition flex items-center">
