                      ...
                      <div key={index} className="p-4 bg-[#0f1020] rounded-xl">
                        ...
                        <div className="mt-3 h-2 bg-gray-800 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min((tool.count / data.summary.totalRequests) * 100, 100)}%`,
                            }}
                          />
                        </div>
                      </div>
              ...
              {data.quotas.length > 0 ? (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {data.quotas.map((quota, index) => (
                    <div
                      key={index}
                      className="p-5 bg-[#0f1020] rounded-xl"
                      data-testid={`quota-${quota.keyId}`}
                    >
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {formatNumber(quota.daily.remaining)} restants
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {formatNumber(quota.monthly.remaining)} restants
                        </p>
                      </div>
                    </div>
                  ))}
