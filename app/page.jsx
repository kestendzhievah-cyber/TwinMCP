...
exports.default = AgentFlowLanding;
const react_1 = __importStar(require("react"));
const navigation_1 = require("next/navigation");
const lucide_react_1 = require("lucide-react");
function AgentFlowLanding() {
    const router = (0, navigation_1.useRouter)();
    const [selectedPlan, setSelectedPlan] = (0, react_1.useState)('professional');
    ...
    const stats = [
        { icon: lucide_react_1.Users, value: '10,000+', label: 'Entreprises actives' },
        { icon: lucide_react_1.MessageSquare, value: '5M+', label: 'Conversations/mois' },
        { icon: lucide_react_1.Clock, value: '80%', label: 'Temps économisé' },
        { icon: lucide_react_1.DollarSign, value: '3.2x', label: 'ROI moyen' }
    ];
    const features = [
        {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex space-x-4">
              <button onClick={() => router.push('/login')} className="px-4 py-2 text-white hover:text-purple-400 transition">
                Connexion
              </button>
              <button onClick={handleFreeTrialOrLogin} className="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition shadow-lg shadow-purple-500/50">
                Essai Gratuit
              </button>
            </div>
          </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <button onClick={handleFreeTrialOrLogin} className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-lg font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition shadow-2xl shadow-purple-500/50 flex items-center justify-center">
              Démarrer Gratuitement
              <lucide_react_1.ArrowRight className="ml-2 w-5 h-5"/>
            </button>
            <button onClick={handleDemo} className="px-8 py-4 bg-white/10 backdrop-blur text-white text-lg font-semibold rounded-lg hover:bg-white/20 transition border border-white/20">
              Voir la Démo
            </button>
          </div>
      ...
      <section id="features" className="py-20 px-4 bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (<div key={index} className="p-8 bg-gradient-to-br from-slate-800/50 to-purple-900/20 rounded-2xl border border-purple-500/20 hover:border-purple-500/50 transition">
      ...
      <section id="pricing" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {plans.map((plan, index) => (<div key={index} className={`relative p-8 rounded-2xl border ${plan.popular
                ? 'bg-gradient-to-br from-purple-900/50 to-pink-900/50 border-purple-500 shadow-2xl shadow-purple-500/30 scale-105'
                : 'bg-slate-800/50 border-slate-700'}`}>
                {plan.popular && (<div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-semibold rounded-full">
                    Le plus populaire
                  </div>)}
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature, fIndex) => (<li key={fIndex} className="flex items-start">
                      <lucide_react_1.Check className="w-5 h-5 text-purple-400 mr-3 flex-shrink-0 mt-0.5"/>
      ...
      <section id="testimonials" className="py-20 px-4 bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (<div key={index} className="p-8 bg-gradient-to-br from-slate-800/50 to-purple-900/20 rounded-2xl border border-purple-500/20">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button onClick={handleFreeTrialOrLogin} className="px-10 py-5 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xl font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition shadow-2xl shadow-purple-500/50">
