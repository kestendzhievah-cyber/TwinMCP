    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/30 to-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-400 text-lg">Conditions générales d'utilisation de TwinMCP</p>
        ...
        <div className="bg-slate-800/50 backdrop-blur border border-purple-500/20 rounded-2xl p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              En accédant et en utilisant TwinMCP (ci-après "le Service"), vous acceptez d'être lié
              par les présentes Conditions d'Utilisation. Si vous n'acceptez pas ces conditions,
              veuillez ne pas utiliser le Service. Nous nous réservons le droit de modifier ces
              conditions à tout moment, et votre utilisation continue du Service constitue votre
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-300">
              <p>
                TwinMCP est une plateforme qui fournit un accès à la documentation de bibliothèques
                de code via le protocole MCP (Model Context Protocol) pour les LLMs et éditeurs de
                code IA.
              </p>
              <p>Le Service comprend :</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Indexation automatique de documentation depuis GitHub, GitLab, Bitbucket et sites
                  web
                </li>
                <li>
                  API MCP pour l'intégration avec des éditeurs de code (Cursor, VS Code, Claude
                  Code, etc.)
                </li>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Ne pas tenter de contourner les mesures de sécurité ou les limitations techniques
                </li>
                <li>Ne pas surcharger ou perturber le fonctionnement du Service</li>
                <li>
                  Ne pas collecter ou extraire des données du Service par des moyens automatisés non
                  autorisés
                </li>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                <h3 className="text-lg font-semibold text-purple-300 mb-2">
                  5.1 Propriété de TwinMCP
                </h3>
                <p>
                  Le Service, y compris son code source, son design, sa structure et tous les
                  contenus associés, est la propriété exclusive de TwinMCP et est protégé par les
              ...
              <div>
                ...
                <p>
                  Vous conservez tous les droits sur les bibliothèques et documentations que vous
                  indexez via le Service. En utilisant le Service, vous nous accordez une licence
                  limitée pour stocker, traiter et afficher ce contenu uniquement dans le but de
                  fournir le Service.
                </p>
              </div>
              <div>
                ...
                <p>
                  La documentation indexée provient de sources tierces (GitHub, sites web, etc.).
                  Nous ne revendiquons aucun droit sur ce contenu et vous êtes responsable de
                  respecter les licences et conditions d'utilisation des bibliothèques que vous
                  indexez.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                <h3 className="text-lg font-semibold text-purple-300 mb-2">
                  6.1 Plans Gratuits et Payants
                </h3>
                <p>
                  TwinMCP propose des plans gratuits et payants. Les fonctionnalités disponibles
                  varient selon le plan choisi. Les prix et fonctionnalités sont indiqués sur notre
              ...
              <div>
                ...
                <p>
                  Les abonnements payants sont facturés mensuellement ou annuellement selon votre
                  choix. Les paiements sont traités de manière sécurisée via nos prestataires de
                  paiement tiers.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  facturation, sauf si vous l'annulez avant la date de renouvellement.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-purple-300 mb-2">6.4 Remboursements</h3>
                <p>
                  Les paiements ne sont généralement pas remboursables, sauf en cas d'erreur de
                  facturation ou si la loi applicable l'exige. Contactez notre support pour toute
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <p>
                En utilisant le Service, vous consentez à la collecte et à l'utilisation de vos
                informations conformément à notre Politique de Confidentialité.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                LE SERVICE EST FOURNI "TEL QUEL" ET "SELON DISPONIBILITÉ", SANS GARANTIE D'AUCUNE
                SORTE, EXPRESSE OU IMPLICITE, Y COMPRIS, MAIS SANS S'Y LIMITER, LES GARANTIES
                IMPLICITES DE QUALITÉ MARCHANDE, D'ADÉQUATION À UN USAGE PARTICULIER ET DE
                NON-CONTREFAÇON.
              </p>
              <p>
                Nous ne garantissons pas que le Service sera ininterrompu, sécurisé ou exempt
                d'erreurs. Nous ne garantissons pas l'exactitude, l'exhaustivité ou l'actualité de
                la documentation indexée.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                DANS TOUTE LA MESURE PERMISE PAR LA LOI, TWINMCP, SES DIRIGEANTS, EMPLOYÉS ET
                PARTENAIRES NE SERONT PAS RESPONSABLES DES DOMMAGES INDIRECTS, ACCESSOIRES,
                SPÉCIAUX, CONSÉCUTIFS OU PUNITIFS, Y COMPRIS, MAIS SANS S'Y LIMITER, LA PERTE DE
                PROFITS, DE DONNÉES, D'UTILISATION OU AUTRES PERTES INTANGIBLES.
              </p>
              <p>
                Notre responsabilité totale envers vous pour toute réclamation découlant de ou liée
                à ces conditions ou au Service ne dépassera pas le montant que vous avez payé à
                TwinMCP au cours des 12 mois précédant la réclamation.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                ...
                <p>
                  ...
                  paramètres de votre compte. La résiliation prendra effet à la fin de votre période
              ...
              <div>
                ...
                <p>
                  Nous pouvons suspendre ou résilier votre accès au Service immédiatement, sans
                  préavis, en cas de violation des présentes conditions ou pour toute autre raison
                  légitime.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  Nous pouvons supprimer vos données après un délai de grâce de 30 jours, sauf
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              Les modifications importantes seront notifiées par email ou via une notification dans
              le Service au moins 30 jours avant leur entrée en vigueur. Votre utilisation continue
              du Service après l'entrée en vigueur des modifications constitue votre acceptation des
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              Ces Conditions d'Utilisation sont régies par les lois françaises, sans égard aux
              principes de conflits de lois. Tout litige découlant de ou lié à ces conditions sera
              soumis à la juridiction exclusive des tribunaux de Paris, France.
            </p>
          </section>
