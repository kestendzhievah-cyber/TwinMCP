...
export class LibraryService {
  ...
  async searchLibraries(query: string, limit: number = 10): Promise<LibraryInfo[]> {
    try {
      ...
      throw new Error(`Failed to search libraries: ${error instanceof Error ? error.message : 'Unknown error'}`)
    }
  }
  ...
  async getPopularLibraries(limit: number = 20): Promise<LibraryInfo[]> {
    try {
      ...
      throw new Error(`Failed to fetch popular libraries: ${error instanceof Error ? error.message : 'Unknown error'}`)
    }
  }
  ...
  async getLibraryVersions(libraryId: string): Promise<string[]> {
    try {
      ...
      throw new Error(`Failed to fetch library versions: ${error instanceof Error ? error.message : 'Unknown error'}`)
    }
  }
  ...
  async getLibraryAliases(libraryId: string): Promise<string[]> {
    try {
      ...
      throw new Error(`Failed to fetch library aliases: ${error instanceof Error ? error.message : 'Unknown error'}`)
    }
  }
  ...
  async resolveAlias(alias: string): Promise<string | null> {
    try {
      ...
      throw new Error(`Failed to resolve alias: ${error instanceof Error ? error.message : 'Unknown error'}`)
    }
  }
}
