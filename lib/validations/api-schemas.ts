...
export const createDownloadSchema = z.object({
  githubUrl: z.string().url().regex(/github\.com\/[^/]+\/[^/]+/, 'Invalid GitHub URL').optional(),
  ...
  (data) => data.githubUrl || (data.type && data.source),
...
export const trackEventSchema = z.object({
  ...
  type: z.union([z.string(), z.object({ name: z.string(), category: z.string(), schema: z.any() })]),
  category: z.union([z.string(), z.object({ id: z.string(), name: z.string(), description: z.string(), metrics: z.array(z.any()) })]),
